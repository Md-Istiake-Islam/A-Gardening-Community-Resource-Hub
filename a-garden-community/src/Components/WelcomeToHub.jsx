...
const WelcomeToHub = () => {
   ...
   return (
      <div className="container 2xl:max-w-6xl bg-base-100 mx-auto text-center pt-10 flex flex-col items-center justify-center px-5 lg:px-0">
         ...
         <div className="container 2xl:max-w-6xl grid grid-cols-1 lg:grid-cols-3 mt-16 gap-7 mb-10">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 container 2xl:max-w-6xl">
